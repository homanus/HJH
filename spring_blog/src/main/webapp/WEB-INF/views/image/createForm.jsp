...
<FORM	 name='frm' 
  ...
  <TABLE class="table table-bordered">
    <TR>
      ...
      <TD><div style="margin:10px"><input type="file" name="fnameMF" accept=".jpg,.png,.gif"></div></TD>
    </TR>
    <TR>
      <TH><div style="margin:10px">이름</div></TH>
      <TD><div style="margin:10px"><input type="text" name="mname" size="90"></div></TD>
    </TR>
    <TR>
      <TH><div style="margin:10px">제목</div></TH>
      <TD><div style="margin:10px"><input type="text" name="title" size="90"></div></TD>
    </TR>
    <TR>
      <TH><div style="margin:10px">내용</div></TH>
      <TD><div style="margin:10px"><textarea name="content" rows="7" cols="90"></textarea></div></TD>
    </TR>
    <TR>
      <TH><div style="margin:10px">비밀번호</div></TH>
      <TD><div style="margin:10px"><input type="password" name="passwd" size="90"></div></TD>
    </TR>
